...
(function(global) {
    ...
    var works = [
        ...
        {
            title: 'this is play attention',
            description: 'descr',
            workcover: '/img/portfolio/work_1p-350.jpg',
            workalt: '',
            worksrcset: '/img/portfolio/work_1p.jpg',
            worksizes: '(min-width: 1500px) 700px, (max-width: 1499px) 450px, (max-width: 1000px) 350px, 700px',
            workcoverbckg: 'background-color: #000 !important',
            workbckg: 'background-color: #000 !important',
            type: 'business',
        ...
        
        {
            ...
            workalt: '',
            worksrcset: '/img/portfolio/work_2p.jpg',
            worksizes: '(min-width: 1500px) 700px, (max-width: 1499px) 450px, (max-width: 1000px) 350px, 700px',
